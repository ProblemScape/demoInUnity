	...
	void OnGUI () {
		...
		if (startNow) {
			...
			case 1:
				...
				GUI.Label (new Rect (xPos+335, yPos - 230, 700, 100), "This fella here has 12 Emeralds and 6 Rubies and wants to get a Paintball shooter with as many paintballs as he has money for! How many paintballs should I give him?\n");
				GUI.Label (new Rect (xPos+305, yPos - 180, 780, 100), "Imagine you are teaching your friend, or brother, or sister to do this problem. What would you tell them to do?");
			...
			case 21:
				...
				GUI.Label (new Rect (xPos+335, yPos - 180, 700, 100), "But wait.... I want to see if this works for the next customer! Missy has 10 Emeralds and 10 Rubies and wants to get a Paintball shooter with a lot of paintballs! How many paintballs should I give her?\n",textStyle);
			...
			case 22:
				yPosNew = yPos + 30;
				GUI.Label (new Rect (xPos+310, yPos - 275, 750, 50), "But wait.... I want to see if this works for another customer ");
				GUI.Label (new Rect (xPos+335, yPos - 230, 700, 100), "Missy has 10 Emeralds and 10 Rubies and wants to get a Paintball shooter with a lot of paintballs! How many paintballs should I give her?\n");
				
				GUI.Label (new Rect (xPos+225, yPos - 110, 250, 50), "This is what you want me to do");
				GUI.Label (new Rect (xPos+540, yPos - 110, 250, 50), "First step for first shopper! ");
				...
				GUI.Label (new Rect (xPos+220, yPos - 90, 250, 100), new GUIContent(enterInstruction1));
				GUI.Label (new Rect (xPos + 540, yPos -90, 250, 100), "Multiply 12 by 5 and then add 6.\n He has 66 Rubies.");
				GUI.Label (new Rect (xPos+820, yPos -80, 200, 100), p2step1, answerStyle);
				GUI.skin = mainSkin;
				/*if (showAnswer) {
